...
class BaseModelOutputWithPast(ModelOutput):
    ...
    hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    attentions: Optional[Tuple[torch.FloatTensor]] = None
    transport_plan: torch.FloatTensor = None
    selected_adapter_idxs: torch.FloatTensor = None
...
class CausalLMOutputWithPast(ModelOutput):
    ...
    loss: Optional[torch.FloatTensor] = None
    # added
    notreduced_loss: Optional[torch.FloatTensor] = None
    logits: torch.FloatTensor = None
    past_key_values: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
    hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    attentions: Optional[Tuple[torch.FloatTensor]] = None
    transport_plan: torch.FloatTensor = None
    selected_adapter_idxs: torch.FloatTensor = None
    prefix_weights: torch.FloatTensor = None
    layer_idxs = None
    ground_truth_pref: torch.FloatTensor = None
    weighted_matrix: torch.FloatTensor = None
    last_hidden_state: Optional[Tuple[torch.FloatTensor]] = None
    
    def post_init(self, prefix_weights = None, layer_idxs = None, ground_truth_pref = None):
        self.prefix_weights = prefix_weights
        self.layer_idxs = layer_idxs
        self.ground_truth_pref = ground_truth_pref
        return self
