...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin, PushToHubMixin, PeftAdapterMixin):
    ...
    def from_pretrained(
        ...
        * `low_cpu_mem_usage` algorithm:
        ...
        if is_peft_available():
            print('is_peft_available, before loading adapter')
        ...
        if model.can_generate() and pretrained_model_name_or_path is not None:
            try:
                print('before model.generation_config load')
                ...
                print('model.generation_config load done?')
            except OSError:
                logger.info(
    ...
    def _load_pretrained_model(
        ...
        if state_dict is not None:
            ...
            print('inner1? :', low_cpu_mem_usage)
            ...
            print('inner2? :', low_cpu_mem_usage)
            ...
            print('inner3? :', low_cpu_mem_usage)
            print('len(resolved_archive_file) > 1:', len(resolved_archive_file) > 1)
            print('len of resolved_archive_file:', len(resolved_archive_file))
            ...
            print('inner4? :', low_cpu_mem_usage)
